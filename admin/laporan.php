            ...
            <div class="bg-white rounded-xl shadow-warm p-6 mb-8 border border-biscuit">
                <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                        ...
                        <input type="date" name="dari" value="<?php echo htmlspecialchars($tanggal_dari); ?>" class="w-full px-4 py-2 border border-biscuit rounded-lg focus:ring-2 focus:ring-[#6F4E37] focus:border-[#6F4E37]">
                    </div>
                    <div>
                        <label class="block text-coffee font-semibold mb-2">Tanggal Sampai</label>
                        <input type="date" name="sampai" value="<?php echo htmlspecialchars($tanggal_sampai); ?>" class="w-full px-4 py-2 border border-biscuit rounded-lg focus:ring-2 focus:ring-[#6F4E37] focus:border-[#6F4E37]">
                    </div>
