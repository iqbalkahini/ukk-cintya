...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($is_edit) {
        ...
        if ($gambar_baru !== '' && file_exists('../uploads/barang/' . $gambar_baru)) {
            unlink('../uploads/barang/' . $gambar_baru);
        }
...
<head>
    ...
    <title><?php echo $edit_data ? 'Edit Barang' : 'Tambah Barang'; ?> - Admin</title>
        ...
        <main class="flex-1 p-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600 mt-2">
                    <?php echo $edit_data ? 'Perbarui data barang yang sudah ada.' : 'Isi form berikut untuk menambahkan barang baru.'; ?>
                </p>
            </div>
                ...
                <form method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="nama_barang" required value="<?php echo htmlspecialchars($edit_data['nama_barang'] ?? ''); ?>" class="w-full px-4 py-2 border border-biscuit rounded-lg focus:ring-2 focus:ring-[#6F4E37] focus:border-[#6F4E37] bg-white" placeholder="Masukkan nama barang">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="harga_awal" value="<?php echo isset($edit_data['harga_awal']) ? number_format($edit_data['harga_awal'], 0, ',', '.') : ''; ?>" onkeyup="formatRupiah(this)" class="w-full pl-12 pr-4 py-2 border border-biscuit rounded-lg focus:ring-2 focus:ring-[#6F4E37] focus:border-[#6F4E37] bg-white" placeholder="0" required>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <p class="text-sm text-coffee mt-2">Gambar saat ini: <?php echo htmlspecialchars($edit_data['gambar']); ?></p>
                            <?php endif; ?>
                        </div>

                        <div class="md:col-span-2">
                            <label class="block text-coffee font-semibold mb-2">Deskripsi Barang <span class="text-red-500">*</span></label>
                            <textarea name="deskripsi_barang" rows="5" required class="w-full px-4 py-2 border border-biscuit rounded-lg focus:ring-2 focus:ring-[#6F4E37] focus:border-[#6F4E37] bg-white" placeholder="Masukkan deskripsi barang"><?php echo htmlspecialchars($edit_data['deskripsi_barang'] ?? ''); ?></textarea>
                        </div>
                    </div>
